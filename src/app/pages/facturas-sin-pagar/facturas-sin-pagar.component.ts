...
@Component({
  selector: 'app-facturas-sin-pagar',
  templateUrl: './facturas-sin-pagar.component.html'
})
export class FacturasSinPagarComponent implements OnInit {
  ...
  obtener_facturas()
  {
    ...
    this.facturaService.facturas_sinPagar_byFecha(fechaDesde, fechaHasta)
    .then((facturas) => {
